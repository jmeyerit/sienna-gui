/******************************************************************************************************************************
 * Assignment Final Project                                                                             meyer3jsDBConnection.cs
 * Justin Meyer
 ...
 * This partial class contains the connection along with the various table adapters used to run the queries against the
 * meyer3js database 
...
namespace meyer3js_FinalProject {
    ...
    partial class meyer3jsDBConnection {
        partial class tStatesSelectedDataTable {
        }
    }
}

namespace meyer3js_FinalProject.meyer3jsDBConnectionTableAdapters {
    partial class tCityWithSpecificStateTableAdapter {
    }

    partial class tStatesSelectedTableAdapter {
    }

    

    partial class tStateTableAdapter {
    }
}
