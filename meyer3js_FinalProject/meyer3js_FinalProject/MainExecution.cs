/******************************************************************************************************************************
 * READ FIRST-------------------------------------
 * This project requires a connection to an instance of SQL Server. The SQL database schema provided
 * with this repository must be built before this program can function correctly. After the schema
 * has been built in your own SQL server instance, create a new connection using the credentials 
 * you have set up for that server.
 * 
 * 
 * Assignment Final Project                                                                                    MainExecution.cs
 * Justin Meyer
 ...
 * This class contains the entry point for the application to run.
...
namespace meyer3js_FinalProject {
    static class MainExecution {
        ...
        static void Main() {
            ...
            Application.Run(new fDestination());
        }
    }
}
